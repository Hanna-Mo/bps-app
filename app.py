...
def get_gpt_reply(entry, goals):
    # 呼びかけリスト
    greetings = [
        "「{user_name}」さん、今日も話してくれてありがとう😊✨",
        "「{user_name}」さん、今日も記録できたこと、素晴らしいですね✨",
        "「{user_name}」さん、今日もお疲れ様です😊✨"
    ]
    # ランダム選択
...
ただし、過剰に出来事と目標の関連性を指摘する必要はありませんし、無理に関連性を見出す必要はありません。必ずしも目標について言及する必要はありません。
"""
